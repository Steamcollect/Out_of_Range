...
namespace FischlWorks_FogWar
{
    ...
    public class FogWarManager : RegularSingleton<FogWarManager>
    {
        ...
        public class FogRevealer
        {
            ...
            public Vector2Int GetCurrentLevelCoordinates(FogWarManager fogWarManager)
            {
                currentLevelCoordinates = new Vector2Int(
                    fogWarManager.GetUnitX(revealerTransform.position.x),
                    fogWarManager.GetUnitY(revealerTransform.position.z));
        ...
        [ShowIf("saveDataOnScan",true), SerializeField] private string levelNameToSave = "Default";
        ...
        public void RemoveFogRevealer(FogRevealer fogRevealer)
        {
            ...
            {
                Debug.LogFormat("Given FogRevealer instance does not exist in the revealers' container");
            }
        }
