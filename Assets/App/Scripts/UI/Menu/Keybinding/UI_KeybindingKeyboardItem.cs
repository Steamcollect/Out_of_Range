...
public class UI_KeybindingKeyboardItem : MonoBehaviour
{
    ...
    public void UpdateDisplay()
    {
        ...
        {
            var binding = m_InputAction.bindings[m_BindingIndex];
    ...
    public void ApplyNewBinding(string newBindingPath)
    {
        if (m_InputAction != null && m_BindingIndex >= 0)
        {
            m_InputAction.ApplyBindingOverride(m_BindingIndex, newBindingPath);
            UpdateDisplay();
        }
    }
}
