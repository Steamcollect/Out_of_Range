...
//         if (m_CurrentPresetIndex < 0) m_CurrentPresetIndex = m_PresetItems.Count - 1;
//
//         ApplyCurrentPreset();
//     }
//
...
//         foreach (UI_KeybindingGamepadItem item in m_PresetItems)
//             if (item != null)
...
//
//         if (m_PresetNameText != null) m_PresetNameText.text = CurrentItem.Preset.PresetName;
//
...
//
//         if (m_PreviousPresetButton != null) m_PreviousPresetButton.interactable = canNavigate;
//
//         if (m_NextPresetButton != null) m_NextPresetButton.interactable = canNavigate;
//     }
//
//     /// <summary>
