...
public class SSO_KeybindingGamepadPreset : ScriptableObject
{
    ...
    public class ActionBinding
    {
        ...
        public List<BindingPath> BindingPaths = new List<BindingPath>();
    ...
    public void ApplyPreset()
    {
        ...
        foreach (var binding in m_ActionBindings)
        {
            ...
            foreach (var bindingPath in binding.BindingPaths)
            {
    ...
    {
        var binding = m_ActionBindings.Find(b => b.ActionName == actionName);
